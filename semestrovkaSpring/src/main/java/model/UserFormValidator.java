...
public class UserFormValidator implements Validator {
    ...
    public void validate(Object obj, Errors errors) {
        ...
        ValidationUtils.rejectIfEmpty(errors, "login", "", "Данное поле не может оставаться пустым");
        ValidationUtils.rejectIfEmpty(errors, "email", "", "Данное поле не может оставаться пустым");
        ValidationUtils.rejectIfEmpty(errors, "password", "", "Данное поле не может оставаться пустым");

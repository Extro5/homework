...
public class UserPostValidator implements Validator {
    ...
    public void validate(Object obj, Errors errors) {
        ...
        ValidationUtils.rejectIfEmpty(errors, "topic", "Empty.field");
        ValidationUtils.rejectIfEmpty(errors, "tag", "Empty.field");
        ValidationUtils.rejectIfEmpty(errors, "description", "Empty.field");
